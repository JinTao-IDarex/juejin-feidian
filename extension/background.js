 ...
 */
import { apiPins, apiRoast, apiModels, apiComment, apiComments, apiRoastConfig, apiLoginCheck } from './api.mjs';
...
const routes = {
  ...
  '/api/login-check': (m, sender) => apiLoginCheck(m.payload || {}, { pageFetch: makePageFetch(sender) }),
